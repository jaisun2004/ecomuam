...
const mockSubmissions: PlanSubmission[] = [
  {
    ...
    status: "pending",
    campaigns: [
      { name: "GDB-BLK-MOR-WD-KW", sku: "Parle-G 1L", platform: "Blinkit", type: "Sponsored Product", city: "Mumbai", dayPart: "Morning", dayType: "Weekday", keywords: [{ keyword: "butter biscuits", bid: "₹ 12", matchType: "Exact" }, { keyword: "tea time biscuits", bid: "₹ 9", matchType: "Phrase" }], budget: "₹ 1,25,000/wk", estRoas: "3.2x", estImpressions: "1.8L" },
      { name: "GDB-BLK-EVE-WD-KW", sku: "Parle-G 1L", platform: "Blinkit", type: "Sponsored Product", city: "Mumbai", dayPart: "Evening", dayType: "Weekday", keywords: [{ keyword: "butter biscuits", bid: "₹ 14", matchType: "Exact" }, { keyword: "evening snacks", bid: "₹ 11", matchType: "Broad" }], budget: "₹ 1,50,000/wk", estRoas: "3.5x", estImpressions: "2.1L" },
      { name: "GDB-BLK-MOR-WE-KW", sku: "Parle-G 1L", platform: "Blinkit", type: "Sponsored Product", city: "Mumbai", dayPart: "Morning", dayType: "Weekend", keywords: [{ keyword: "butter biscuits", bid: "₹ 15", matchType: "Exact" }], budget: "₹ 1,00,000/wk", estRoas: "3.8x", estImpressions: "1.5L" },
      { name: "GDB-ZEP-MOR-WD-KW", sku: "Parle-G 1L", platform: "Zepto", type: "Sponsored Product", city: "Mumbai", dayPart: "Morning", dayType: "Weekday", keywords: [{ keyword: "butter biscuits", bid: "₹ 10", matchType: "Exact" }, { keyword: "biscuits online", bid: "₹ 8", matchType: "Phrase" }, { keyword: "britannia biscuits", bid: "₹ 13", matchType: "Exact" }], budget: "₹ 2,50,000/wk", estRoas: "4.0x", estImpressions: "3.2L" },
      { name: "GDB-ZEP-EVE-WD-KW", sku: "Parle-G 1L", platform: "Zepto", type: "Sponsored Product", city: "Delhi NCR", dayPart: "Evening", dayType: "Weekday", keywords: [{ keyword: "butter biscuits", bid: "₹ 11", matchType: "Exact" }, { keyword: "mcvities digestive", bid: "₹ 14", matchType: "Exact" }], budget: "₹ 2,25,000/wk", estRoas: "3.6x", estImpressions: "2.8L" },
      { name: "NCD-BLK-MOR-WD-CAT", sku: "Aquafina 1.5L", platform: "Blinkit", type: "Sponsored Brand", city: "Bengaluru", dayPart: "Morning", dayType: "Weekday", keywords: [{ keyword: "digestive biscuits", bid: "₹ 9", matchType: "Exact" }, { keyword: "healthy snacks", bid: "₹ 7", matchType: "Phrase" }], budget: "₹ 1,00,000/wk", estRoas: "2.9x", estImpressions: "1.4L" },
      { name: "NCD-ZEP-EVE-WE-CAT", sku: "Aquafina 1.5L", platform: "Zepto", type: "Sponsored Brand", city: "Bengaluru", dayPart: "Evening", dayType: "Weekend", keywords: [{ keyword: "digestive biscuits", bid: "₹ 11", matchType: "Exact" }, { keyword: "parle biscuits", bid: "₹ 12", matchType: "Exact" }], budget: "₹ 1,75,000/wk", estRoas: "3.4x", estImpressions: "2.2L" },
      { name: "GDB-ZEP-MOR-WE-COMP", sku: "Parle-G 1L", platform: "Zepto", type: "Sponsored Product", city: "Delhi NCR", dayPart: "Morning", dayType: "Weekend", keywords: [{ keyword: "sunfeast biscuits", bid: "₹ 16", matchType: "Exact" }, { keyword: "parle biscuits", bid: "₹ 14", matchType: "Exact" }], budget: "₹ 2,00,000/wk", estRoas: "2.8x", estImpressions: "2.0L" },
    ],
    cities: [
