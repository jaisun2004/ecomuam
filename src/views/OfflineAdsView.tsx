    ...
    <div className="space-y-6 pb-20">
      ...
      {tab === "overview" ? (<>
        <div className="grid grid-cols-4 gap-4">
          ...
          <KPICard title="Cities to Target" value="5" delta="Based on online penetration" deltaType="positive" <KPICard title="Cities to Target" value="5" delta="Based on online penetration" deltaType="positive" sub="Strategic — high online penetration signals offline demand" accentColor="bg-sw-amber" delay={0.15} /> accentColor="bg-sw-amber" delay={0.15} />
        </div>
