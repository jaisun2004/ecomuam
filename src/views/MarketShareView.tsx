    ...
    <div className="space-y-6 pb-20">
      ...
      {tab === "overview" ? (<>
        <div className="grid grid-cols-4 gap-4">
          ...
          <KPICard title="Platform Where You Lead" value="Flipkart" delta="Highest share: 31%" deltaType="positive" <KPICard title="Platform Where You Lead" value="Flipkart" delta="Highest share: 31%" deltaType="positive" sub="Strong — Flipkart dominance from better pricing + content" accentColor="bg-sw-purple" delay={0.15} /> accentColor="bg-sw-purple" delay={0.15} />
        </div>
