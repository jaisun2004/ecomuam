...
const reportData: ReportPlatform[] = [
  {
    ...
    campaigns: [
      { name: "Good Day Butter — Sponsored", status: "LIVE", spend: "₹4.2L", roas: "5.1x", roasColor: "text-sw-green", impressions: "842K", clicks: "28.4K", ctr: "3.4%",
        keywords: [
          { keyword: "butter biscuits online", impressions: "342K", clicks: "12.8K", spend: "₹1.8L", roas: "6.2x", roasColor: "text-sw-green",
            cities: [
              { city: "Delhi NCR", impressions: "98K", clicks: "4.1K", spend: "₹52K", roas: "6.5x", roasColor: "text-sw-green", products: [{ code: "SKU-GD200", title: "Good Day Butter 200g", spend: "₹32K", roas: "6.6x", roasColor: "text-sw-green" }, { code: "SKU-GD100", title: "Good Day Butter 100g", spend: "₹20K", roas: "6.5x", roasColor: "text-sw-green" }] },
              { city: "Mumbai", impressions: "82K", clicks: "3.2K", spend: "₹44K", roas: "6.4x", roasColor: "text-sw-green", products: [{ code: "SKU-GD200", title: "Good Day Butter 200g", spend: "₹28K", roas: "6.4x", roasColor: "text-sw-green" }] },
            ],
          },
      ...
      { name: "Marie Gold — Keyword Target", status: "PAUSED", spend: "₹1.8L", roas: "2.1x", roasColor: "text-sw-red", impressions: "284K", clicks: "8.2K", ctr: "2.9%",
        keywords: [{ keyword: "glucose biscuits bulk", impressions: "187K", clicks: "5.4K", spend: "₹1.2L", roas: "1.4x", roasColor: "text-sw-red",
          cities: [{ city: "Delhi NCR", impressions: "62K", clicks: "1.8K", spend: "₹42K", roas: "1.4x", roasColor: "text-sw-red", products: [{ code: "SKU-MG250", title: "Marie Gold 250g", spend: "₹42K", roas: "1.4x", roasColor: "text-sw-red" }] }],
        }],
      },
    ],
  },
  {
    ...
    campaigns: [
      { name: "Q-Commerce Biscuit Push", status: "LIVE", spend: "₹2.8L", roas: "3.8x", roasColor: "text-sw-amber", impressions: "412K", clicks: "14.8K", ctr: "3.6%",
        keywords: [
          { keyword: "butter biscuits", impressions: "188K", clicks: "7.2K", spend: "₹1.4L", roas: "4.0x", roasColor: "text-sw-green",
            cities: [{ city: "Delhi NCR", impressions: "92K", clicks: "3.8K", spend: "₹72K", roas: "4.3x", roasColor: "text-sw-green", products: [{ code: "SKU-GD200", title: "Good Day Butter 200g", spend: "₹48K", roas: "4.4x", roasColor: "text-sw-green" }, { code: "SKU-5050", title: "50-50 Maska Chaska 120g", spend: "₹24K", roas: "4.2x", roasColor: "text-sw-green" }] }],
          },
    ...
    campaigns: [
      { name: "Marie Gold Retargeting", status: "PAUSED", spend: "₹3.0L", roas: "2.1x", roasColor: "text-sw-red", impressions: "524K", clicks: "12.8K", ctr: "2.4%",
        keywords: [{ keyword: "glucose biscuits", impressions: "284K", clicks: "6.2K", spend: "₹1.8L", roas: "1.4x", roasColor: "text-sw-red",
          cities: [{ city: "Delhi NCR", impressions: "82K", clicks: "1.8K", spend: "₹52K", roas: "1.4x", roasColor: "text-sw-red", products: [{ code: "SKU-MG250", title: "Marie Gold 250g", spend: "₹52K", roas: "1.4x", roasColor: "text-sw-red" }] }],
        }],
      },
    ],
  },
...
const platformBreakdown = [
  { platform: "Amazon", spend: 78, roas: 5.1, color: "#FF9900" },
  { platform: "Blinkit", spend: 33, roas: 3.8, color: "#FDDC2B" },
  { platform: "Flipkart", spend: 52, roas: 2.1, color: "#2F77FF" },
  { platform: "Zepto", spend: 18, roas: 3.2, color: "#833AB4" },
  { platform: "Instagram", spend: 41, roas: 4.4, color: "#E1306C" },
];
