...
const reportData: ReportPlatform[] = [
  {
    ...
    campaigns: [
      { name: "Parle-G 250g — Sponsored", status: "LIVE", spend: "₹ 4.2L", roas: "5.1x", roasColor: "text-sw-green", impressions: "842K", clicks: "28.4K", ctr: "3.4%",
        keywords: [
          ...
          { keyword: "cream biscuits", impressions: "498K", clicks: "14.2K", spend: "₹ 2.25L", roas: "3.1x", roasColor: "text-sw-amber" },
        ],
      },
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 pb-10">
      ...
      <div className="grid grid-cols-5 gap-4">
        <KPICard title="Total Spend (30D)" value="₹ 18.4L" delta="▲ ₹ 2.25L MoM" deltaType="positive" sub="24 campaigns" accentColor="bg-primary" delay={0} />
