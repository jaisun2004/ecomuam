...
const ActionPlanDetail = ({ s }: { s: Scenario }) => {
  const campaignBreakdown = [
    { name: `GDB-BLK-MOR-WD`, sku: "Parle-G 120g", platform: "Blinkit", city: "Mumbai", dayPart: "Morning", dayType: "Weekday", keywords: [{ kw: "butter biscuits", bid: s.id === "A" ? "₹ 12" : s.id === "B" ? "₹ 10" : "₹ 8" }, { kw: "tea time biscuits", bid: s.id === "A" ? "₹ 9" : "₹ 7" }], budget: s.id === "A" ? "₹ 1.25L/wk" : s.id === "B" ? "₹ 1.5L/wk" : "₹ 1.8L/wk", estRoas: s.id === "A" ? "3.2x" : s.id === "B" ? "2.8x" : "2.4x", estImpr: "1.8L" },
    { name: `GDB-BLK-EVE-WD`, sku: "Parle-G 250g", platform: "Blinkit", city: "Mumbai", dayPart: "Evening", dayType: "Weekday", keywords: [{ kw: "butter biscuits", bid: s.id === "A" ? "₹ 14" : "₹ 11" }, { kw: "evening snacks", bid: "₹ 11" }], budget: s.id === "A" ? "₹ 1.5L/wk" : "₹ 1.2L/wk", estRoas: s.id === "A" ? "3.5x" : "2.9x", estImpr: "2.120g" },
    { name: `GDB-ZEP-MOR-WD`, sku: "Parle-G 250g", platform: "Zepto", city: "Delhi NCR", dayPart: "Morning", dayType: "Weekday", keywords: [{ kw: "butter biscuits", bid: "₹ 10" }, { kw: "britannia biscuits", bid: "₹ 13" }], budget: s.id === "A" ? "₹ 2.5L/wk" : s.id === "B" ? "₹ 1.8L/wk" : "₹ 1.5L/wk", estRoas: s.id === "A" ? "4.0x" : "3.2x", estImpr: "3.200g" },
    { name: `GDB-ZEP-EVE-WE`, sku: "Parle-G 120g", platform: "Zepto", city: "Delhi NCR", dayPart: "Evening", dayType: "Weekend", keywords: [{ kw: "sunfeast biscuits", bid: "₹ 16" }, { kw: "parle biscuits", bid: "₹ 14" }], budget: s.id === "A" ? "₹ 200g/wk" : "₹ 1.2L/wk", estRoas: s.id === "A" ? "2.8x" : "2.5x", estImpr: "2.0L" },
    { name: `NCD-BLK-MOR-WD`, sku: "Britannia Marie 150g", platform: "Blinkit", city: "Bengaluru", dayPart: "Morning", dayType: "Weekday", keywords: [{ kw: "digestive biscuits", bid: "₹ 9" }, { kw: "healthy snacks", bid: "₹ 7" }], budget: s.id === "A" ? "₹ 250g/wk" : "₹ 1.2L/wk", estRoas: "2.9x", estImpr: "1.4L" },
