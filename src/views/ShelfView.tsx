...
const regionPincodes: Record<string, { pin: string; marketShare: number; availability: number; priceIndex: number; sos: number; city: string }[]> = {
  "Delhi NCR": [
    { pin: "110001", marketShare: 42, availability: 98, priceIndex: 0.93, sos: 34, city: "New Delhi" },
    { pin: "110003", marketShare: 38, availability: 95, priceIndex: 0.91, sos: 28, city: "New Delhi" },
    { pin: "110016", marketShare: 22, availability: 61, priceIndex: 1.02, sos: 18, city: "South Delhi" },
    { pin: "110017", marketShare: 35, availability: 88, priceIndex: 0.95, sos: 30, city: "South Delhi" },
    { pin: "110025", marketShare: 8, availability: 12, priceIndex: 1.14, sos: 5, city: "East Delhi" },
    { pin: "110044", marketShare: 19, availability: 55, priceIndex: 1.05, sos: 14, city: "West Delhi" },
    { pin: "110048", marketShare: 5, availability: 8, priceIndex: 1.18, sos: 3, city: "South Delhi" },
    { pin: "110051", marketShare: 37, availability: 92, priceIndex: 0.92, sos: 31, city: "North Delhi" },
    { pin: "110062", marketShare: 16, availability: 44, priceIndex: 1.08, sos: 11, city: "West Delhi" },
    { pin: "110065", marketShare: 40, availability: 96, priceIndex: 0.90, sos: 33, city: "South Delhi" },
    { pin: "110067", marketShare: 24, availability: 67, priceIndex: 0.99, sos: 20, city: "West Delhi" },
    { pin: "110070", marketShare: 10, availability: 23, priceIndex: 1.12, sos: 7, city: "South Delhi" },
  ...
  "Mumbai": [
    { pin: "400001", marketShare: 44, availability: 96, priceIndex: 0.90, sos: 36, city: "South Mumbai" },
    { pin: "400050", marketShare: 38, availability: 88, priceIndex: 0.94, sos: 30, city: "Bandra" },
    { pin: "400070", marketShare: 21, availability: 52, priceIndex: 1.04, sos: 16, city: "Kurla" },
    { pin: "400076", marketShare: 12, availability: 34, priceIndex: 1.10, sos: 8, city: "Powai" },
    { pin: "400092", marketShare: 31, availability: 78, priceIndex: 0.97, sos: 25, city: "Borivali" },
    { pin: "400607", marketShare: 28, availability: 72, priceIndex: 0.99, sos: 22, city: "Navi Mumbai" },
  ],
  "Bangalore": [
    { pin: "560001", marketShare: 46, availability: 97, priceIndex: 0.89, sos: 38, city: "MG Road" },
    { pin: "560034", marketShare: 40, availability: 91, priceIndex: 0.92, sos: 33, city: "Koramangala" },
    { pin: "560066", marketShare: 25, availability: 64, priceIndex: 1.03, sos: 19, city: "Whitefield" },
    { pin: "560095", marketShare: 18, availability: 48, priceIndex: 1.07, sos: 12, city: "Electronic City" },
    { pin: "560103", marketShare: 33, availability: 82, priceIndex: 0.95, sos: 27, city: "HSR Layout" },
  ],
};
...
const IndiaMapView: React.FC<{
  ...
  const regionPositions: Record<string, { x: number; y: number }> = {
    "Delhi NCR": { x: 150, y: 95 },
    "Mumbai": { x: 105, y: 195 },
    "Bangalore": { x: 140, y: 280 },
  };
...
const ShelfView: React.FC = () => {
  ...
  const [sosPlatform, setSosPlatform] = useState("Amazon");
  ...
  const currentSearchData = searchDataByPlatform[sosPlatform] || searchDataByPlatform.Amazon;
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <KPICard title="OOS Products Today" value="6" delta="▲ 2 vs yesterday" deltaType="negative" <KPICard title="OOS Products Today" value="6" delta="▲ 2 vs yesterday" deltaType="negative" sub="Bad — replenishment delays impacting 2 platforms" accentColor="bg-sw-red" delay={0.05} /> delay={0.05} />
        <KPICard title="Share of Search" value="28%" delta="▲ 1.8% MoM" deltaType="positive" <KPICard title="Share of Search" value="28%" delta="▲ 1.8% MoM" deltaType="positive" sub="Positive — improved keyword bidding lifting presence" accentColor="bg-primary" delay={0.1} /> accentColor="bg-primary" delay={0.1} />
        <KPICard title="Content Score Avg" value="62%" delta="⚠ 11 SKUs need update" deltaType="warning" <KPICard title="Content Score Avg" value="62%" delta="⚠ 11 SKUs need update" deltaType="warning" sub="Needs work — outdated images and titles on 11 SKUs" accentColor="bg-sw-amber" delay={0.15} /> accentColor="bg-sw-amber" delay={0.15} />
      </div>
        ...
        <PanelCard title="Content Health Breakdown" badge="By Platform" badgeColor="accent" delay={0.52}>
          <div className="space-y-3">
            {platformsList.slice(0, 4).map(p => {
              const score = p.name === "Amazon" ? 72 : p.name === "Flipkart" ? 58 : p.name === "Blinkit" ? 45 : 38;
