    ...
    <div className="space-y-6 pb-20">
      ...
      {tab === "overview" ? (<>
        <div className="grid grid-cols-4 gap-4">
          ...
          <KPICard title="Conversion Uplift" value="+4,600" delta="Monthly projection" deltaType="positive" <KPICard title="Conversion Uplift" value="+4,600" delta="Monthly projection" deltaType="positive" sub="Positive — reallocating to top campaigns lifts volume" accentColor="bg-sw-cyan" delay={0.1} /> accentColor="bg-sw-cyan" delay={0.1} />
