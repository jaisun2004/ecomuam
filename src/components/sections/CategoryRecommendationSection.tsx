  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-4">
        <KPICard title="Top Opportunity Score" value="85/100" change={0} changeLabel="High — strong whitespace for new variant" icon={<Lightbulb className="h-5 w-5" />} variant="primary" />
        <KPICard title="Category Growth" value="+12%" change={12} changeLabel="Positive — category expanding quarter over quarter" icon={<TrendingUp className="h-5 w-5" />} variant="success" />
        <KPICard title="Whitespace Gaps" value="4" change={0} changeLabel="Actionable — ready for product line expansion" icon={<BarChart3 className="h-5 w-5" />} variant="warning" />
      </div>
